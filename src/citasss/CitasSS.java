 ...
 * @author vPalomo
 */
public class CitasSS extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Crear citas");
        ...
        jMenuItem3.setText("Lista Persona");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        frame.getContentPane().add(new CitasTrabajadorasPanel(this));
        frame.pack();
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        JDialog frame = new JDialog(this, "Gestion de personas", true);
        frame.setDefaultCloseOperation(JDialog.HIDE_ON_CLOSE);
        frame.getContentPane().add(new MttoPersonaPanel(MttoPersonaPanel.ALTA));
        frame.pack();
        frame.setLocationRelativeTo(this);
        frame.setVisible(true);
        //iniciarMisComponentes();
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        JDialog frame = new JDialog(this, "Gestion de personas", true);
        frame.setDefaultCloseOperation(JDialog.HIDE_ON_CLOSE);
        frame.getContentPane().add(new ListaPersonasPanel("", "0", ListaPersonasPanel.CONSULTA_ALTA));
        frame.pack();
        frame.setLocationRelativeTo(this);
        frame.setVisible(true);
        //iniciarMisComponentes();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CitasSS.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
            ...
            public void mouseClicked(java.awt.event.MouseEvent e) {
                ...
                if (e.getClickCount() == 2) {
                    ...
                    if (nombre == null || "".equalsIgnoreCase(nombre)) {
                        ...
                        frame.setDefaultCloseOperation(JDialog.HIDE_ON_CLOSE);
                        frame.getContentPane().add(new ListaPersonasPanel(id, idTrabajadora, ListaPersonasPanel.ALTA_CITA));
                        frame.pack();
